...
FOOD_WEBS = [
    {
        ...
        "members": [
            # producers
            "Salix exigua", "Pinus contorta", "Bouteloua gracilis",
            # primary consumers
            "Cervus canadensis", "Bison bison", "Antilocapra americana",
            "Odocoileus virginianus", "Castor canadensis",
            # secondary / apex
            "Canis lupus", "Canis latrans", "Ursus arctos horribilis",
            "Vulpes vulpes", "Aquila chrysaetos", "Corvus corax",
            "Oncorhynchus nerka",
        ],
        "trophic_edges": [
            # (predator, prey) — directional. Used to compute trophic level + draw arrows.
            ("Cervus canadensis", "Salix exigua"),
            ("Cervus canadensis", "Pinus contorta"),
            ("Cervus canadensis", "Bouteloua gracilis"),
            ("Bison bison",       "Bouteloua gracilis"),
            ("Bison bison",       "Salix exigua"),
            ("Antilocapra americana", "Bouteloua gracilis"),
            ("Odocoileus virginianus", "Salix exigua"),
            ("Odocoileus virginianus", "Bouteloua gracilis"),
            ("Castor canadensis", "Salix exigua"),
            ("Canis lupus",       "Cervus canadensis"),
            ("Canis lupus",       "Bison bison"),
            ("Canis lupus",       "Castor canadensis"),
            ("Canis latrans",     "Antilocapra americana"),
            ("Canis latrans",     "Odocoileus virginianus"),
            ("Canis latrans",     "Castor canadensis"),
            ("Ursus arctos horribilis", "Oncorhynchus nerka"),
            ("Ursus arctos horribilis", "Cervus canadensis"),
            ("Ursus arctos horribilis", "Salix exigua"),
            ("Aquila chrysaetos", "Antilocapra americana"),
            ("Aquila chrysaetos", "Vulpes vulpes"),
            ("Vulpes vulpes",     "Castor canadensis"),
            ("Corvus corax",      "Oncorhynchus nerka"),
        ],
    ...
    },
    {
        ...
        "trophic_edges": [
            ("Strongylocentrotus purpuratus", "Macrocystis pyrifera"),
            ("Haliotis rufescens",            "Macrocystis pyrifera"),
            ("Pugettia producta",             "Macrocystis pyrifera"),
            ("Hypsypops rubicundus",          "Pugettia producta"),
            ("Enhydra lutris",                "Strongylocentrotus purpuratus"),  # keystone edge
            ("Enhydra lutris",                "Haliotis rufescens"),
            ("Enhydra lutris",                "Pugettia producta"),
            ("Pycnopodia helianthoides",      "Strongylocentrotus purpuratus"),
            ("Octopus vulgaris",              "Pugettia producta"),
            ("Triakis semifasciata",          "Octopus vulgaris"),
            ("Triakis semifasciata",          "Hypsypops rubicundus"),
            ("Carcharodon carcharias",        "Zalophus californianus"),
            ("Carcharodon carcharias",        "Triakis semifasciata"),
            ("Carcharodon carcharias",        "Enhydra lutris"),
            ("Orcinus orca",                  "Zalophus californianus"),
    ...
    },
    {
        ...
        "trophic_edges": [
            ("Connochaetes taurinus",   "Bouteloua gracilis"),
            ("Equus quagga",            "Bouteloua gracilis"),
            ("Eudorcas thomsonii",      "Bouteloua gracilis"),
            ("Ceratotherium simum",     "Vachellia drepanolobium"),
            ("Papio anubis",            "Bouteloua gracilis"),
            ("Pseudomyrmex ferruginea", "Vachellia drepanolobium"),
            ("Panthera leo",            "Connochaetes taurinus"),
            ("Panthera leo",            "Equus quagga"),
            ("Panthera leo",            "Eudorcas thomsonii"),
            ("Acinonyx jubatus",        "Eudorcas thomsonii"),
            ("Panthera pardus",         "Eudorcas thomsonii"),
            ("Panthera pardus",         "Papio anubis"),
            ("Crocuta crocuta",         "Connochaetes taurinus"),
            ("Crocuta crocuta",         "Eudorcas thomsonii"),
            ("Crocodylus niloticus",    "Connochaetes taurinus"),
            ("Crocodylus niloticus",    "Equus quagga"),
            ("Gyps africanus",          "Panthera leo"),          # vulture scavenges lion kills
            ("Gyps africanus",          "Crocuta crocuta"),
        ],
    ...
    },
    {
        ...
        "trophic_edges": [
            ("Acropora millepora",            "Symbiodinium microadriaticum"),  # coral hosts the alga (productivity flows up)
            ("Scarus guacamaia",              "Acropora millepora"),             # parrotfish grazes coral
            ("Strongylocentrotus purpuratus", "Acropora millepora"),
            ("Odontodactylus scyllarus",      "Strongylocentrotus purpuratus"),
            ("Octopus vulgaris",              "Odontodactylus scyllarus"),
            ("Gymnothorax javanicus",         "Octopus vulgaris"),
            ("Gymnothorax javanicus",         "Lutjanus kasmira"),
            ("Epinephelus tukula",            "Lutjanus kasmira"),
            ("Epinephelus tukula",            "Scarus guacamaia"),
            ("Carcharhinus melanopterus",     "Lutjanus kasmira"),
            ("Carcharhinus melanopterus",     "Epinephelus tukula"),
            ("Carcharhinus melanopterus",     "Gymnothorax javanicus"),
            ("Manta birostris",               "Symbiodinium microadriaticum"),    # filter-feeds plankton incl. dinoflagellates
            ("Amphiprion ocellaris",          "Heteractis magnifica"),            # protective housing (mutualism — special edge)
            ("Labroides dimidiatus",          "Epinephelus tukula"),              # cleans grouper (mutualism)
        ],
    ...
    },
    {
        ...
        "trophic_edges": [
            ("Boreogadus saida",     "Calanus glacialis"),
            ("Pusa hispida",         "Boreogadus saida"),
            ("Monodon monoceros",    "Boreogadus saida"),
            ("Delphinapterus leucas","Boreogadus saida"),
            ("Ursus maritimus",      "Pusa hispida"),
            ("Vulpes lagopus",       "Pusa hispida"),
            ("Vulpes lagopus",       "Dicrostonyx groenlandicus"),
            ("Bubo scandiacus",      "Dicrostonyx groenlandicus"),
            ("Orcinus orca",         "Pusa hispida"),
            ("Orcinus orca",         "Monodon monoceros"),
    ...
    },
    {
        ...
        "trophic_edges": [
            ("Bradypus variegatus",       "Ficus aurea"),
            ("Bradypus variegatus",       "Heliconia rostrata"),
            ("Dasyprocta leporina",       "Bertholletia excelsa"),       # seed-cracker mutualism
            ("Hydrochoerus hydrochaeris", "Heliconia rostrata"),
            ("Ara macao",                 "Bertholletia excelsa"),
            ("Danaus plexippus",          "Heliconia rostrata"),
            ("Trochilus polytmus",        "Heliconia rostrata"),         # nectar pollination
            ("Panthera onca",             "Hydrochoerus hydrochaeris"),
            ("Panthera onca",             "Dasyprocta leporina"),
            ("Panthera onca",             "Bradypus variegatus"),
            ("Harpia harpyja",            "Bradypus variegatus"),
            ("Harpia harpyja",            "Ara macao"),
            ("Eunectes murinus",          "Hydrochoerus hydrochaeris"),
            ("Eunectes murinus",          "Pygocentrus nattereri"),
            ("Pygocentrus nattereri",     "Dasyprocta leporina"),         # river-crossing
        ],
